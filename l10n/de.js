OC.L10N.register(
    ...
    "Comment cannot exceed {max} characters." : "Der Kommentar darf nich länger als {max} Zeichen sein.",
    ...
    "There was an error adding the IP to the allow list." : "Beim Hinzufügen der IP zur Liste der zugelassenen IPs ist ein Fehler aufgetreten.",
    "There was an error updating the allow list entry." : "Fehler beim Aktualisieren des Eintrags in der Liste der zugelassenen IPs.",
    ...
    "Bypass rate limiting for allowed IPs" : "Ratenbegrenzung für zugelassene IPs umgehen",
