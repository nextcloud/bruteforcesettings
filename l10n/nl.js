OC.L10N.register(
    ...
    "Bypass rate limiting for allowed IPs" : "Negeer de limiet op het aantal verzoeken voor de toegestane IP adressen",
    "Add new IP address" : "Voeg nieuw IP adres toe",
    "IP address" : "IP-adres",
    "Mask" : "Masker",
    "Comment" : "Notitie",
    "Add" : "Toevoegen",
    "Edit comment for {subnet}" : "Geef commentaar op {subnet}",
    "Save" : "Opslaan",
    "Delete entry for {subnet}" : "Invoer verwijderen voor {subnet}",
    "Comment cannot exceed {max} characters." : "Reactie kan niet langer zijn dan {max} karakters.",
    "Leave an internal comment, why this IP is allowed, e.g. the  location, so it can be revoked, when it is no longer needed." : "Laat een interne reactie achter, waarom dit IP wordt toegestaan, b.v. de locatie, zodat het kan worden ingetrokken als het niet meer in gebruik is.",
    ...
    "There was an error adding the IP to the allow list." : "Er is een fout opgetreden bij het toevoegen van het IP adres aan de toegestane lijst",
    "There was an error updating the allow list entry." : "Er is een fout opgetreden bij het actualiseren van het toegestane lijst veld."
},
