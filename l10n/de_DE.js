OC.L10N.register(
    ...
    "Your current IP address is detected as \"{remoteAddress}\". This address is currently throttled. Current delay: {delay} ms." : "Ihre aktuelle IP-Adresse wurde als \"{remoteAddress}\" erkannt. Diese Adresse ist derzeit gedrosselt. Aktuelle Verzögerung: {delay} ms.",
    "Your current IP address is detected as \"{remoteAddress}\". This address bypasses brute-force protection." : "Ihre aktuelle IP-Adresse wird als \"{remoteAddress}\" erkannt. Diese Adresse umgeht den Brute-Force-Schutz.",
    "Your current IP address is detected as \"{remoteAddress}\". This address is not currently throttled." : "Ihre aktuelle IP-Adresse wird als \"{remoteAddress}\" erkannt. Diese Adresse wird derzeit nicht gedrosselt.",
