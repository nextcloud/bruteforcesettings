OC.L10N.register(
    ...
    "The comment cannot exceed {max} characters." : "O comentário não pode exceder {max} caracteres.",
    ...
    "Your current IP address is detected as \"{remoteAddress}\". This address bypasses brute-force protection." : "Seu endereço IP atual foi detectado como \"{remoteAddress}\". Este endereço contorna a proteção contra ataques de força bruta.",
    "Failed to add the IP address to the allow list." : "Falha ao adicionar o endereço IP à lista de permissões.",
    "Failed to update the allow list entry." : "Falha ao atualizar a entrada da lista de permissões",
