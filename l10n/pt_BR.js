OC.L10N.register(
    ...
    "Your current IP address is detected as \"{remoteAddress}\". This address is currently throttled. Current delay: {delay} ms." : "Seu endereço IP atual foi detectado como \"{remoteAddress}\". Este endereço está atualmente com o tráfego limitado. Atraso atual: {delay} ms",
    ...
    "Your current IP address is detected as \"{remoteAddress}\". This address is not currently throttled." : "Seu endereço IP atual foi detectado como \"{remoteAddress}\". Este endereço não está sujeito a restrições no momento.",
