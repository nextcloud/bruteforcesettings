OC.L10N.register(
    ...
    "The comment cannot exceed {max} characters." : "Коментар не може перевищувати {max} символів.",
    "Your current IP address is detected as \"{remoteAddress}\". This address is currently throttled. Current delay: {delay} ms." : "Ваша поточна адреса IP: \"{remoteAddress}\". Зараз застосовано уповільнення до цієї адреси. Поточна затримка складає {delay} мс.",
    "Your current IP address is detected as \"{remoteAddress}\". This address bypasses brute-force protection." : "Ваша поточна адреса IP: \"{remoteAddress}\". До цієї адреси не застосується захист від брутфорсу.",
    "Your current IP address is detected as \"{remoteAddress}\". This address is not currently throttled." : "Ваша поточна адреса IP: \"{remoteAddress}\". Ця адреса не уповільнюється.",
    "Failed to add the IP address to the allow list." : "Не вдалося додати адресу IP до переліку дозволених адрес.",
    "Failed to save the rate limit setting." : "Не вдалося зберегти налаштування обмеження.",
    "Failed to update the allow list entry." : "Не вдалося оновити перелік дозволених адрес.",
    ...
    "Comment" : "Коментар",
    "Add" : "Додати",
    "Edit comment for {subnet}" : "Редагувати коментар для {subnet}",
    "Save" : "Зберегти",
    "Delete entry for {subnet}" : "Вилучити запис для {subnet}",
    "Comment cannot exceed {max} characters." : "Довжина коментаря перебільшує {max} символів.",
    "Leave an internal comment, why this IP is allowed, e.g. the  location, so it can be revoked, when it is no longer needed." : "Залиште внутрішній коментар, чому ця адреса IP є дозволеною, напр., місце розташування, щоби його можна було відкликати, як зникне потреба.",
